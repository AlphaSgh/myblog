...
public class Blog {
    ...
    @JsonFormat(pattern = "yyyy-MMj-dd HH:mm:ss", timezone = "GMT+8")
    ...
    public String toString() {
        ...
        sb.append(", blogSubUrl='").append(blogSubUrl).append('\'');
        sb.append(", blogCoverImage='").append(blogCoverImage).append('\'');
        sb.append(", blogCategoryId=").append(blogCategoryId);
        sb.append(", blogCategoryName='").append(blogCategoryName).append('\'');
        sb.append(", blogTags='").append(blogTags).append('\'');
        ...
        sb.append(", blogContent='").append(blogContent).append('\'');
        sb.append('}');
        return sb.toString();
    }
}
